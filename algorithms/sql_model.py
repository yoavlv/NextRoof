    ...
    try:
        ...
        with conn:
            with conn.cursor() as cursor:
                insert_sql = """
                    INSERT INTO ml_models (model_name, city_id, model_data, model_scaler, scores, params)
                    VALUES (%s, %s, %s, %s, %s, %s)
                ...
                """
                cursor.execute(insert_sql, (model_name, city_id, model_data, model_scaler, scores, params))
